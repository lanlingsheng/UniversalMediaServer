...
import net.pms.util.jna.macos.corefoundation.CFTypeArrayRef;
import net.pms.util.jna.macos.corefoundation.CoreFoundation;
import net.pms.util.jna.macos.corefoundation.TerminatedStringEncodingArray;
...
import net.pms.util.jna.macos.types.IOObjectTRef;
